defmodule TrackdogWeb.EventLiveTest do
  ...
  @create_attrs %{date: "2010-04-17T14:00:00Z", result: 42, track: "some track"}
  ...
  describe "Index" do
    ...
    test "updates event in listing", %{conn: conn, event: event} do
      ...
      assert html =~ "some updated track"
    end
